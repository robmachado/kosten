...
<div class="panel panel-default">
    <div class="panel-heading">
        <p>Parâmetros</p>
        <p><strong>FOB</strong> (gde SP) <strong>{{ $params['destino'] }}</strong>  <strong>{{ 'ICMS: ' . number_format($params['icms'],0,'','') }}% </strong> Tingimento: <strong>{{ $params['tingimento'] }}</strong> Embalagem: <strong>{{ $params['embalagem'] }}</strong></p>    
    </div>
